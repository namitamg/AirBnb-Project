                ...
                <div className="row">
                    <div className="col-8 m-auto">
                        <form>
                                ...
                                <div>
                                    ...
                                    <div className="row">
                                        <div className="col-9 m-auto">
                                            <div className="d-flex justify-content-between">
                                                <p>Booking done -Eco hub Hotels, Goa</p>
                            ...
                            {count === 3 ? (
                            <div>
                       <Link to="/"  >   <button className="btn btn-sm btn-outline-primary" type="submit" onClick={()=>alert("Thanks, Enjoy the stay")}>Confirm booking</button></Link>
                            </div>
                            ) : null}
                        </form>
                        <div>
